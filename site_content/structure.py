...
def get_directory_structure(rootdir, ext):
    ...
    for path, dirs, files in os.walk(rootdir):
        ...
        files = [x for x in files if x.endswith('.%s' % ext)]
...
pages = Pages([
    ...
    Page('Core Elements', children=[
        Page('Typography', 'pages/core_elements/typography.html',
    ...
    Page('In Page Components', children=[
        Page('Navigation', children=[
            ...
            Page('Pills (Stacked)', 'pages/components/navigation/pills_stacked.html',
                 scss=['components/navigation/_nav.scss']),
            Page('Stages', 'pages/components/navigation/stages.html', scss=['components/navigation/_nav.scss']),
            Page('Pagination', 'pages/components/navigation/pagination.html',
                 scss=['components/navigation/_pagination.scss']),
